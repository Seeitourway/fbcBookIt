...
namespace FbcBookIt.DataAccess
{
	...
	public partial interface IBookInventoryContext: IDisposable
	{
		...
		IDbSet<Volume> VolumeDb { get; set; }
		IDbSet<VolumeStatus> VolumeStatusDb { get; set; }
	
	}
	
	public partial class BookInventoryContext: DbContext, IBookInventoryContext
	{
		static BookInventoryContext()
		{
			Database.SetInitializer<BookInventoryContext>(null);
		}
		...
		protected override void OnModelCreating(DbModelBuilder aModelBuilder)
		{
			...
			aModelBuilder.Configurations.Add(new VolumeMap());
			aModelBuilder.Configurations.Add(new VolumeStatusMap());
		}
		...
		public IDbSet<Volume> VolumeDb { get; set; }
		public IDbSet<VolumeStatus> VolumeStatusDb { get; set; }
